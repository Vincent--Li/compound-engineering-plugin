...
```bash
gh issue create \
  --repo Vincent--Li/compound-engineering-plugin \
...
3. Let them know the maintainer (Vincent Li) will be notified
...
Issue: https://github.com/Vincent--Li/compound-engineering-plugin/issues/[NUMBER]
